...
import com.example.labmedixapplication.activities.LabInformationActivity;
import com.example.labmedixapplication.activities.RegisterActivity;

public class CheakPhoneNoFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View v =inflater.inflate(R.layout.fragment_cheak_phone_no, container, false);
        ...
        to_start.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
              //  text_view_edit.setVisibility(View.GONE);

              //  getActivity().getSupportFragmentManager().beginTransaction().replace(R.id.reg ,new LabrotoryInformationFragment()).commit();
                Intent intent = new Intent(getContext() , LabInformationActivity.class);
